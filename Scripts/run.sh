...
echo "Configuring"
cmake -B "${buildPath}" -S "${sourceDir}" -DCMAKE_CXX_COMPILER_LAUNCHER=ccache -G "Ninja" -DCMAKE_C_COMPILER="clang-12" -DCMAKE_CXX_COMPILER="clang-12" -DCMAKE_CXX_FLAGS="-fuse-ld=mold"
echo "Building"
